...
class SelfAttention(nn.Module):
    ...
    def forward(self, values, keys, queries, mask):
        ...
        keys = keys.reshape(N, keys_len, self.heads, self.heads_dim)
        queries = queries.reshape(N, queries_len, self.heads, self.heads_dim)
...
class DecoderBlock(nn.Module):
    ...
    def forward(self, x, values, keys, src_mask, trg_mask):
        ...
        out = self.transform_block(values, keys, queries, src_mask)
        return out
